...
<script>
    var vitesse = document.querySelectorAll('a.vitesse');
    var effectif = document.querySelectorAll('a.effectif');
    var panne = document.querySelectorAll('a.panne');
    var affluence = document.querySelectorAll('a.affluence');
    var affichage = document.querySelector(".affichage")
    var affichage2 = document.querySelector(".affichage2")
    var affichage3 = document.querySelector(".affichage3")
    var affichage4 = document.querySelector(".affichage4")
    
    for (i = 0; i < vitesse.length; i++) {
        effectif[i].onclick = (event) =>{
            event.preventDefault();
            document.querySelector(".affichage").classList.add("cache");
            document.querySelector(".affichage3").classList.add("cache");
            document.querySelector(".affichage2").classList.remove("cache");
            document.querySelector(".affichage4").classList.add("cache");
        };

        panne[i].onclick = (event) =>{
            event.preventDefault();
            document.querySelector(".affichage").classList.add("cache");
            document.querySelector(".affichage3").classList.remove("cache");
            document.querySelector(".affichage2").classList.add("cache");
            document.querySelector(".affichage4").classList.add("cache");
        };

        vitesse[i].onclick = (event) =>{
            event.preventDefault();
            document.querySelector(".affichage").classList.remove("cache");
            document.querySelector(".affichage3").classList.add("cache");
            document.querySelector(".affichage2").classList.add("cache");
            document.querySelector(".affichage4").classList.add("cache");
        };

        affluence[i].onclick = (event) =>{
            event.preventDefault();
            document.querySelector(".affichage").classList.add("cache");
            document.querySelector(".affichage3").classList.add("cache");
            document.querySelector(".affichage2").classList.add("cache");
            document.querySelector(".affichage4").classList.remove("cache");
        };
    }
